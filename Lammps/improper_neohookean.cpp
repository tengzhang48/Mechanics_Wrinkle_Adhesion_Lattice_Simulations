/* ----------------------------------------------------------------------
   ...
   u_a = -k1*A0 -k1*lnJ + k2/2*(lnJ)^2    k1: mu ; k2: lammda ; chi: initial area of element
   J = A/A0
------------------------------------------------------------------------- */
...
//	printf("area %12.9f\n", area);
    ...
    if (eflag) eimproper = (1.0/2.0*k2[type]*log(domega) - k1[type])*log(domega)*chi[type]-k1[type]*chi[type];
